 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getPort <em>Port</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getPin <em>Pin</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getDefaultState <em>Default State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#isKeepOnReconnect <em>Keep On Reconnect</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16()
 * @model
 * @generated
 */
public interface DigitalActorIO16 extends DigitalActor, IODevice, MTFConfigConsumer<TFIOActorConfiguration> {
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16_DeviceType()
   ...
   * @see #setPort(char)
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16_Port()
   * @model unique="false"
   * @generated
   */
	char getPort();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getPort <em>Port</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see #setPin(int)
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16_Pin()
   * @model unique="false"
   * @generated
   */
	int getPin();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getPin <em>Pin</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16_DefaultState()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#getDefaultState <em>Default State</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getDigitalActorIO16_KeepOnReconnect()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.DigitalActorIO16#isKeepOnReconnect <em>Keep On Reconnect</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
