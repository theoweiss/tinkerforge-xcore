 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.MStepperCurrent#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getMStepperCurrent()
...
public interface MStepperCurrent extends MStepperDevice, MSensor<DecimalValue> {
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getMStepperCurrent_DeviceType()
