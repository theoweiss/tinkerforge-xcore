 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.BrickletColorConfiguration#getGain <em>Gain</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.BrickletColorConfiguration#getIntegrationTime <em>Integration Time</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getBrickletColorConfiguration()
 * @model
 * @generated
 */
public interface BrickletColorConfiguration extends TFConfig {
   ...
   * @see #setGain(Short)
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getBrickletColorConfiguration_Gain()
   * @model unique="false"
   * @generated
   */
	Short getGain();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.BrickletColorConfiguration#getGain <em>Gain</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getBrickletColorConfiguration_IntegrationTime()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.BrickletColorConfiguration#getIntegrationTime <em>Integration Time</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
