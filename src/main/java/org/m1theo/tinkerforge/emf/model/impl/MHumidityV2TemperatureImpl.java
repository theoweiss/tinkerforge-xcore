...
import org.m1theo.tinkerforge.emf.model.MHumidityV2Temperature;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MHumidityV2TemperatureImpl#getThreshold <em>Threshold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MHumidityV2TemperatureImpl extends MinimalEObjectImpl.Container implements MHumidityV2Temperature {
  ...
  public NotificationChain basicSetTfConfig(TFBaseConfiguration newTfConfig, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG, oldTfConfig, newTfConfig);
  ...
  public void setTfConfig(TFBaseConfiguration newTfConfig) {
    if (newTfConfig != tfConfig) {
      ...
      if (tfConfig != null)
        msgs = ((InternalEObject)tfConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG, null, msgs);
      if (newTfConfig != null)
        msgs = ((InternalEObject)newTfConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG, null, msgs);
      msgs = basicSetTfConfig(newTfConfig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG, newTfConfig, newTfConfig));
  }
  ...
  public void setThreshold(BigDecimal newThreshold) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MHUMIDITY_V2_TEMPERATURE__THRESHOLD, oldThreshold, threshold));
  }
   ...
   */
    public void init() {
      ...
      logger = LoggerFactory.getLogger(MHumidityV2TemperatureImpl.class);
  }
  ...
  public void enable() {
    ...
    try {
      tinkerforgeDevice.setTemperatureCallbackConfiguration(getCallbackPeriod(), true, 'x', 0, 0);
  ...
  private class TemperatureListener implements BrickletHumidityV2.TemperatureListener {

    @Override
    public void temperature(int newValue) {
   ...
   */
    ...
    switch (featureID) {
      ...
      case ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG:
   ...
   */
    ...
    switch (featureID) {
      ...
      case ModelPackage.MHUMIDITY_V2_TEMPERATURE__THRESHOLD:
        return getThreshold();
    }
   ...
   */
    ...
    if (baseClass == MTFConfigConsumer.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG: return ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MTFConfigConsumer.class) {
      switch (baseFeatureID) {
        case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG: return ModelPackage.MHUMIDITY_V2_TEMPERATURE__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
