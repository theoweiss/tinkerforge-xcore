 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getHouseCode <em>House Code</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getReceiverCode <em>Receiver Code</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getRepeats <em>Repeats</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchA()
 * @model
 * @generated
 */
public interface RemoteSwitchA extends RemoteSwitch, MTFConfigConsumer<RemoteSwitchAConfiguration> {
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchA_DeviceType()
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchA_HouseCode()
   * @model unique="false"
   * @generated
   */
	Short getHouseCode();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getHouseCode <em>House Code</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchA_ReceiverCode()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getReceiverCode <em>Receiver Code</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchA_Repeats()
   * @model unique="false"
   * @generated
   */
	Short getRepeats();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchA#getRepeats <em>Repeats</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
