 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getSystemCode <em>System Code</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getDeviceCode <em>Device Code</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getRepeats <em>Repeats</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchC()
 * @model
 * @generated
 */
public interface RemoteSwitchC extends RemoteSwitch, MTFConfigConsumer<RemoteSwitchCConfiguration> {
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchC_DeviceType()
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchC_SystemCode()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getSystemCode <em>System Code</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchC_DeviceCode()
   * @model unique="false"
   * @generated
   */
	Short getDeviceCode();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getDeviceCode <em>Device Code</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getRemoteSwitchC_Repeats()
   * @model unique="false"
   * @generated
   */
	Short getRepeats();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.RemoteSwitchC#getRepeats <em>Repeats</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
