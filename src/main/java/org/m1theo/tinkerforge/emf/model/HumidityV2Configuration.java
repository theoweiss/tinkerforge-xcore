 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getHeaterConfiguration <em>Heater Configuration</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getMovingAverageLengthHumidity <em>Moving Average Length Humidity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getMovingAverageLengthTemperature <em>Moving Average Length Temperature</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getHumidityV2Configuration()
 * @model
 * @generated
 */
public interface HumidityV2Configuration extends TFConfig {
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getHumidityV2Configuration_HeaterConfiguration()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getHeaterConfiguration <em>Heater Configuration</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getHumidityV2Configuration_MovingAverageLengthHumidity()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getMovingAverageLengthHumidity <em>Moving Average Length Humidity</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getHumidityV2Configuration_MovingAverageLengthTemperature()
   * @model unique="false"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.HumidityV2Configuration#getMovingAverageLengthTemperature <em>Moving Average Length Temperature</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
