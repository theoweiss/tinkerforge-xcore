...
import org.m1theo.tinkerforge.emf.model.MBrickletSoundIntensity;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.impl.MBrickletSoundIntensityImpl#getThreshold <em>Threshold</em>}</li>
 * </ul>
 *
 * @generated
 */
