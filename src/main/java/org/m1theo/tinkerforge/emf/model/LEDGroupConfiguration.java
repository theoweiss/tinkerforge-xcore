 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.model.LEDGroupConfiguration#getLeds <em>Leds</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getLEDGroupConfiguration()
 * @model
 * @generated
 */
public interface LEDGroupConfiguration extends TFConfig {
   ...
   * @see #setLeds(String)
   * @see org.m1theo.tinkerforge.emf.model.ModelPackage#getLEDGroupConfiguration_Leds()
   * @model unique="false"
   * @generated
   */
	String getLeds();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.model.LEDGroupConfiguration#getLeds <em>Leds</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
