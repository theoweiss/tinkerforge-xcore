 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getSwitchState <em>Switch State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.LEDGroupImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEDGroupImpl extends MinimalEObjectImpl.Container implements LEDGroup {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getLEDGroup();
  }
   ...
   */
    ...
    public void turnSwitch(OnOffValue state) {
        if (state == OnOffValue.OFF) {
            ...
            setSelectedColor(new HSBValue(Color.BLACK));
        } else {
            setSelectedColor(lastONValue);
        }
     ...
     */
    @Override
    public void setSelectedColor(HSBValue color) {
   ...
   */
    ...
    if (baseClass == SimpleColorActor.class) {
      switch (baseOperationID) {
        case ModelPackage.SIMPLE_COLOR_ACTOR___SET_SELECTED_COLOR__HSBVALUE: return ModelPackage.LED_GROUP___SET_SELECTED_COLOR__HSBVALUE;
        default: return -1;
      }
    }
    if (baseClass == SwitchSensor.class) {
   ...
   */
    ...
    switch (operationID) {
      ...
      case ModelPackage.LED_GROUP___FETCH_SWITCH_STATE:
        fetchSwitchState();
        return null;
      case ModelPackage.LED_GROUP___SET_SELECTED_COLOR__HSBVALUE:
        setSelectedColor((HSBValue)arguments.get(0));
        return null;
