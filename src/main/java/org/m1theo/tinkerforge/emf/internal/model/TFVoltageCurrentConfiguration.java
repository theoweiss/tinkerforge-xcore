 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getAveraging <em>Averaging</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getVoltageConversionTime <em>Voltage Conversion Time</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getCurrentConversionTime <em>Current Conversion Time</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFVoltageCurrentConfiguration()
 * @model
 * @generated
 */
public interface TFVoltageCurrentConfiguration extends TFConfig {
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFVoltageCurrentConfiguration_Averaging()
   * @model unique="false"
   * @generated
   */
	Short getAveraging();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getAveraging <em>Averaging</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFVoltageCurrentConfiguration_VoltageConversionTime()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getVoltageConversionTime <em>Voltage Conversion Time</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFVoltageCurrentConfiguration_CurrentConversionTime()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.TFVoltageCurrentConfiguration#getCurrentConversionTime <em>Current Conversion Time</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
