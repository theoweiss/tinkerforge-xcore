 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getMaxVelocity <em>Max Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getDeacceleration <em>Deacceleration</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getMotorCurrent <em>Motor Current</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getStepMode <em>Step Mode</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getDecay <em>Decay</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#isSyncRect <em>Sync Rect</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFBrickStepperConfigurationImpl#getTimeBase <em>Time Base</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFBrickStepperConfigurationImpl extends TFBaseConfigurationImpl implements TFBrickStepperConfiguration {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getTFBrickStepperConfiguration();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__MAX_VELOCITY, oldMaxVelocity, maxVelocity));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__ACCELERATION, oldAcceleration, acceleration));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__DEACCELERATION, oldDeacceleration, deacceleration));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__MOTOR_CURRENT, oldMotorCurrent, motorCurrent));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__STEP_MODE, oldStepMode, stepMode));
  }
   ...
   */
    ...
    decay = newDecay;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__DECAY, oldDecay, decay));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__SYNC_RECT, oldSyncRect, syncRect));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TF_BRICK_STEPPER_CONFIGURATION__TIME_BASE, oldTimeBase, timeBase));
  }
