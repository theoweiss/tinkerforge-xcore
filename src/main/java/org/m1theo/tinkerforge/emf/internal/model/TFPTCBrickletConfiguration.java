 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.TFPTCBrickletConfiguration#getNoiseRejectionFilter <em>Noise Rejection Filter</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.TFPTCBrickletConfiguration#getWireMode <em>Wire Mode</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFPTCBrickletConfiguration()
 * @model
 * @generated
 */
public interface TFPTCBrickletConfiguration extends TFConfig {
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFPTCBrickletConfiguration_NoiseRejectionFilter()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.TFPTCBrickletConfiguration#getNoiseRejectionFilter <em>Noise Rejection Filter</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getTFPTCBrickletConfiguration_WireMode()
   * @model unique="false"
   * @generated
   */
	Short getWireMode();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.TFPTCBrickletConfiguration#getWireMode <em>Wire Mode</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
