...
import org.m1theo.tinkerforge.emf.internal.model.ConfigOptsServo;
...
import org.m1theo.tinkerforge.emf.internal.model.MBrickServo;
import org.m1theo.tinkerforge.emf.internal.model.MServo;
...
import org.m1theo.tinkerforge.emf.internal.model.TFServoConfiguration;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getSwitchState <em>Switch State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getPercentValue <em>Percent Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getVelocity <em>Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getMaxPosition <em>Max Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getMinPosition <em>Min Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getPulseWidthMin <em>Pulse Width Min</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getPulseWidthMax <em>Pulse Width Max</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getPeriod <em>Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getOutputVoltage <em>Output Voltage</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MServoImpl#getTargetPosition <em>Target Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MServoImpl extends MinimalEObjectImpl.Container implements MServo {
   ...
   */
     ...
     */
    @Override
    public void setValue(PercentValue newPercentValue, DeviceOptions opts) {
        ...
        Short newVelocity = abs.divide(new BigDecimal(100)).multiply(newPercentValue.getValue()).subtract(min.abs())
                .shortValue();
   ...
   */
    ...
    if (baseClass == MoveActor.class) {
      switch (baseOperationID) {
        case ModelPackage.MOVE_ACTOR___MOVE__UPDOWNVALUE_DEVICEOPTIONS: return ModelPackage.MSERVO___MOVE__UPDOWNVALUE_DEVICEOPTIONS;
    ...
    if (baseClass == DimmableActor.class) {
      switch (baseOperationID) {
        case ModelPackage.DIMMABLE_ACTOR___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS: return ModelPackage.MSERVO___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
    if (baseClass == PercentTypeActor.class) {
      switch (baseOperationID) {
        case ModelPackage.PERCENT_TYPE_ACTOR___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS: return ModelPackage.MSERVO___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
    if (baseClass == SetPointActor.class) {
   ...
   */
    ...
    switch (operationID) {
      ...
      case ModelPackage.MSERVO___SET_VALUE__BIGDECIMAL_DEVICEOPTIONS:
        ...
        return null;
      case ModelPackage.MSERVO___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS:
        setValue((PercentValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
      case ModelPackage.MSERVO___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS:
        dimm((IncreaseDecreaseValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
      case ModelPackage.MSERVO___MOVE__UPDOWNVALUE_DEVICEOPTIONS:
