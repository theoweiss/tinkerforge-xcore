 ...
 * <!-- end-user-doc -->
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDualButtonDevicePosition()
 * @model
 * @generated
 */
public enum DualButtonDevicePosition implements Enumerator {
   ...
   * @generated
   */
	private static final DualButtonDevicePosition[] VALUES_ARRAY =
		new DualButtonDevicePosition[] {
      LEFT,
      RIGHT,
    };
   ...
   * @generated
   */
	public static final List<DualButtonDevicePosition> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
