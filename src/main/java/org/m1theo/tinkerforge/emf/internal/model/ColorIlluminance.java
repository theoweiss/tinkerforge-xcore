 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.ColorIlluminance#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.ColorIlluminance#getGain <em>Gain</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.ColorIlluminance#getIntegrationTime <em>Integration Time</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getColorIlluminance()
...
public interface ColorIlluminance extends BrickletColorDevice, MSensor<DecimalValue>, MTFConfigConsumer<TFBaseConfiguration>, CallbackListener {
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getColorIlluminance_DeviceType()
   ...
   * @see #setGain(Short)
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getColorIlluminance_Gain()
   * @model unique="false"
   * @generated
   */
	Short getGain();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.ColorIlluminance#getGain <em>Gain</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getColorIlluminance_IntegrationTime()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.ColorIlluminance#getIntegrationTime <em>Integration Time</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
