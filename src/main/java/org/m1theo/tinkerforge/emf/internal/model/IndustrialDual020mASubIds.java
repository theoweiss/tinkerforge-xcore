 ...
 * <!-- end-user-doc -->
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getIndustrialDual020mASubIds()
 * @model
 * @generated
 */
public enum IndustrialDual020mASubIds implements Enumerator {
   ...
   * @generated
   */
	private static final IndustrialDual020mASubIds[] VALUES_ARRAY =
		new IndustrialDual020mASubIds[] {
      SENSOR0,
      SENSOR1,
    };
   ...
   * @generated
   */
	public static final List<IndustrialDual020mASubIds> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   */
    ...
    switch (value) {
      case SENSOR0_VALUE: return SENSOR0;
    }
    return null;
  }
