...
import org.m1theo.tinkerforge.emf.internal.model.MBrickletUVLight;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletUVLightImpl#getThreshold <em>Threshold</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBrickletUVLightImpl extends MinimalEObjectImpl.Container implements MBrickletUVLight {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getMBrickletUVLight();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__LOGGER, oldLogger, logger));
  }
   ...
   */
    ...
    poll = newPoll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__POLL, oldPoll, poll));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__ENABLED_A, oldEnabledA, enabledA));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__IP_CONNECTION, oldIpConnection, ipConnection));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__CONNECTED_UID, oldConnectedUid, connectedUid));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__POSITION, oldPosition, position));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__DEVICE_IDENTIFIER, oldDeviceIdentifier, deviceIdentifier));
  }
   ...
   */
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__NAME, oldName, name));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.MBRICKLET_UV_LIGHT__BRICKD) return null;
   ...
   */
    ...
    if (newBrickd != eInternalContainer() || (eContainerFeatureID() != ModelPackage.MBRICKLET_UV_LIGHT__BRICKD && newBrickd != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__BRICKD, newBrickd, newBrickd));
  }
  ...
  public void setSensorValue(DecimalValue newSensorValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__SENSOR_VALUE, oldSensorValue, sensorValue));
  }
   ...
   */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG, oldTfConfig, newTfConfig);
   ...
   */
    ...
    if (newTfConfig != tfConfig) {
      NotificationChain msgs = null;
      if (tfConfig != null)
        msgs = ((InternalEObject)tfConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG, null, msgs);
      if (newTfConfig != null)
        msgs = ((InternalEObject)newTfConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG, null, msgs);
      msgs = basicSetTfConfig(newTfConfig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG, newTfConfig, newTfConfig));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__CALLBACK_PERIOD, oldCallbackPeriod, callbackPeriod));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_UV_LIGHT__THRESHOLD, oldThreshold, threshold));
  }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_UV_LIGHT__SENSOR_VALUE: return ModelPackage.MSENSOR__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG: return ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_UV_LIGHT__CALLBACK_PERIOD: return ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseFeatureID) {
        case ModelPackage.MSENSOR__SENSOR_VALUE: return ModelPackage.MBRICKLET_UV_LIGHT__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (baseFeatureID) {
        case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG: return ModelPackage.MBRICKLET_UV_LIGHT__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
      switch (baseFeatureID) {
        case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD: return ModelPackage.MBRICKLET_UV_LIGHT__CALLBACK_PERIOD;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseOperationID) {
        case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE: return ModelPackage.MBRICKLET_UV_LIGHT___FETCH_SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
