 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFPTCBrickletConfigurationImpl#getNoiseRejectionFilter <em>Noise Rejection Filter</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.TFPTCBrickletConfigurationImpl#getWireMode <em>Wire Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFPTCBrickletConfigurationImpl extends MinimalEObjectImpl.Container implements TFPTCBrickletConfiguration {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getTFPTCBrickletConfiguration();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TFPTC_BRICKLET_CONFIGURATION__NOISE_REJECTION_FILTER, oldNoiseRejectionFilter, noiseRejectionFilter));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TFPTC_BRICKLET_CONFIGURATION__WIRE_MODE, oldWireMode, wireMode));
  }
   ...
   */
    ...
    switch (featureID) {
      case ModelPackage.TFPTC_BRICKLET_CONFIGURATION__NOISE_REJECTION_FILTER:
        return NOISE_REJECTION_FILTER_EDEFAULT == null ? noiseRejectionFilter != null : !NOISE_REJECTION_FILTER_EDEFAULT.equals(noiseRejectionFilter);
      case ModelPackage.TFPTC_BRICKLET_CONFIGURATION__WIRE_MODE:
