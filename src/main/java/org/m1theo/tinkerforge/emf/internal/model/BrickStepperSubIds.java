 ...
 * <!-- end-user-doc -->
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getBrickStepperSubIds()
 * @model
 * @generated
 */
public enum BrickStepperSubIds implements Enumerator {
   ...
   * @generated
   */
	private static final BrickStepperSubIds[] VALUES_ARRAY =
		new BrickStepperSubIds[] {
      STEPPER_DRIVE,
      STEPPER_VELOCITY,
      STEPPER_CURRENT,
      STEPPER_POSITION,
      STEPPER_STEPS,
      STEPPER_STACK_VOLTAGE,
      STEPPER_EXTERNAL_VOLTAGE,
      STEPPER_CONSUMPTION,
      STEPPER_UNDER_VOLTAGE,
      STEPPER_STATE,
      STEPPER_CHIP_TEMPERATURE,
      STEPPER_LED,
    };
   ...
   */
    ...
    switch (value) {
      case STEPPER_DRIVE_VALUE: return STEPPER_DRIVE;
    }
    return null;
  }
