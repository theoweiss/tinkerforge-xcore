 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColorColorImpl extends MinimalEObjectImpl.Container implements ColorColor {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getColorColor();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR__ENABLED_A, oldEnabledA, enabledA));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.COLOR_COLOR__MBRICK) return null;
   ...
   */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR__TF_CONFIG, oldTfConfig, newTfConfig);
   ...
   */
    ...
    if (newTfConfig != tfConfig) {
      NotificationChain msgs = null;
      if (tfConfig != null)
        msgs = ((InternalEObject)tfConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COLOR_COLOR__TF_CONFIG, null, msgs);
      if (newTfConfig != null)
        msgs = ((InternalEObject)newTfConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COLOR_COLOR__TF_CONFIG, null, msgs);
      msgs = basicSetTfConfig(newTfConfig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR__TF_CONFIG, newTfConfig, newTfConfig));
  }
   ...
   */
    ...
    public void fetchSensorValue() {
        try {
            ...
            setSensorValue(new HSBValue(
                    new Color(getRGBValue(color.r), getRGBValue(color.g), getRGBValue(color.b))));
    ...
    private class ColorListener implements BrickletColor.ColorListener {
        ...
        public void color(int r, int g, int b, int c) {
            ...
            setSensorValue(new HSBValue(new Color(getRGBValue(r), getRGBValue(g), getRGBValue(b))));
        }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (derivedFeatureID) {
        case ModelPackage.COLOR_COLOR__SENSOR_VALUE: return ModelPackage.MSENSOR__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (derivedFeatureID) {
        case ModelPackage.COLOR_COLOR__TF_CONFIG: return ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseFeatureID) {
        case ModelPackage.MSENSOR__SENSOR_VALUE: return ModelPackage.COLOR_COLOR__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (baseFeatureID) {
        case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG: return ModelPackage.COLOR_COLOR__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseOperationID) {
        case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE: return ModelPackage.COLOR_COLOR___FETCH_SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
