...
import org.m1theo.tinkerforge.emf.internal.model.Dual020mADevice;
import org.m1theo.tinkerforge.emf.internal.model.MBrickd;
import org.m1theo.tinkerforge.emf.internal.model.MBrickletIndustrialDual020mA;
...
import org.m1theo.tinkerforge.emf.internal.model.TFIndustrialDual020mAConfiguration;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getMsubdevices <em>Msubdevices</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletIndustrialDual020mAImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBrickletIndustrialDual020mAImpl extends MinimalEObjectImpl.Container
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getMBrickletIndustrialDual020mA();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__LOGGER, oldLogger, logger));
  }
   ...
   */
    ...
    uid = newUid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__UID, oldUid, uid));
  }
   ...
   */
    ...
    poll = newPoll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__POLL, oldPoll, poll));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__ENABLED_A, oldEnabledA, enabledA));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__CONNECTED_UID, oldConnectedUid, connectedUid));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__POSITION, oldPosition, position));
  }
   ...
   */
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__NAME, oldName, name));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__BRICKD) return null;
   ...
   */
    ...
    msgs = eBasicSetContainer((InternalEObject)newBrickd, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__BRICKD, msgs);
    return msgs;
  }
   ...
   */
    ...
    if (newBrickd != eInternalContainer() || (eContainerFeatureID() != ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__BRICKD && newBrickd != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__BRICKD, newBrickd, newBrickd));
  }
   ...
   */
    ...
    if (msubdevices == null) {
      msubdevices = new EObjectContainmentWithInverseEList<Dual020mADevice>(Dual020mADevice.class, this, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK) { private static final long serialVersionUID = 1L; @Override public Class<?> getInverseFeatureClass() { return MSubDevice.class; } };
    }
    return msubdevices;
  }
   ...
   */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__TF_CONFIG, oldTfConfig, newTfConfig);
   ...
   */
    ...
    if (newTfConfig != tfConfig) {
      NotificationChain msgs = null;
      if (tfConfig != null)
        msgs = ((InternalEObject)tfConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__TF_CONFIG, null, msgs);
      if (newTfConfig != null)
        msgs = ((InternalEObject)newTfConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__TF_CONFIG, null, msgs);
      msgs = basicSetTfConfig(newTfConfig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_INDUSTRIAL_DUAL020M_A__TF_CONFIG, newTfConfig, newTfConfig));
  }
