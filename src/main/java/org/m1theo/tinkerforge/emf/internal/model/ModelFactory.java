...
public interface ModelFactory extends EFactory {
   ...
   * @generated
   */
	ModelFactory eINSTANCE = org.m1theo.tinkerforge.emf.internal.model.impl.ModelFactoryImpl.init();
   ...
   */
	...
	/**
   * Returns a new object of class '<em>MBricklet Humidity V2</em>'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return a new object of class '<em>MBricklet Humidity V2</em>'.
   * @generated
   */
	MBrickletHumidityV2 createMBrickletHumidityV2();

	/**
   * Returns a new object of class '<em>MHumidity V2 Temperature</em>'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return a new object of class '<em>MHumidity V2 Temperature</em>'.
   * @generated
   */
	MHumidityV2Temperature createMHumidityV2Temperature();

	/**
   * Returns a new object of class '<em>MHumidity V2 Humidity</em>'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return a new object of class '<em>MHumidity V2 Humidity</em>'.
   * @generated
   */
	MHumidityV2Humidity createMHumidityV2Humidity();
   ...
   */
	...
	/**
   * Returns a new object of class '<em>Humidity V2 Configuration</em>'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return a new object of class '<em>Humidity V2 Configuration</em>'.
   * @generated
   */
	HumidityV2Configuration createHumidityV2Configuration();
