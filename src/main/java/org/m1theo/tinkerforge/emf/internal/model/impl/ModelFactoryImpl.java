...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
   ...
   */
    ...
    switch (eClass.getClassifierID()) {
      ...
      case ModelPackage.MBRICKLET_ANALOG_OUT_V2: return createMBrickletAnalogOutV2();
      ...
      case ModelPackage.MBRICK_STEPPER: return createMBrickStepper();
      case ModelPackage.TF_BRICK_STEPPER_CONFIGURATION: return createTFBrickStepperConfiguration();
      case ModelPackage.MSTEPPER_DRIVE: return createMStepperDrive();
      case ModelPackage.MSTEPPER_VELOCITY: return createMStepperVelocity();
      case ModelPackage.MSTEPPER_CURRENT: return createMStepperCurrent();
      case ModelPackage.MSTEPPER_POSITION: return createMStepperPosition();
      case ModelPackage.MSTEPPER_STEPS: return createMStepperSteps();
      case ModelPackage.MSTEPPER_STACK_VOLTAGE: return createMStepperStackVoltage();
      case ModelPackage.MSTEPPER_EXTERNAL_VOLTAGE: return createMStepperExternalVoltage();
      case ModelPackage.MSTEPPER_CONSUMPTION: return createMStepperConsumption();
      case ModelPackage.MSTEPPER_UNDER_VOLTAGE: return createMStepperUnderVoltage();
      case ModelPackage.MSTEPPER_STATE: return createMStepperState();
      case ModelPackage.MSTEPPER_CHIP_TEMPERATURE: return createMStepperChipTemperature();
      case ModelPackage.MSTEPPER_STATUS_LED: return createMStepperStatusLed();
      ...
      case ModelPackage.MBRICKLET_THERMOCOUPLE: return createMBrickletThermocouple();
      case ModelPackage.MBRICKLET_UV_LIGHT: return createMBrickletUVLight();
      case ModelPackage.MBRICKLET_CO2: return createMBrickletCO2();
      ...
      case ModelPackage.MBRICKLET_HUMIDITY_V2: return createMBrickletHumidityV2();
      case ModelPackage.MHUMIDITY_V2_TEMPERATURE: return createMHumidityV2Temperature();
      case ModelPackage.MHUMIDITY_V2_HUMIDITY: return createMHumidityV2Humidity();
      ...
      case ModelPackage.MBRICKLET_OLED12_8X64: return createMBrickletOLED128x64();
      case ModelPackage.MBRICKLET_OLE6_4X48: return createMBrickletOLE64x48();
      ...
      case ModelPackage.HUMIDITY_V2_CONFIGURATION: return createHumidityV2Configuration();
      ...
      case ModelPackage.TF_THERMOCOUPLE_CONFIGURATION: return createTFThermocoupleConfiguration();
      ...
      case ModelPackage.BRICKLET_OLED_CONFIGURATION: return createBrickletOLEDConfiguration();
      default:
   ...
   */
    ...
    switch (eDataType.getClassifierID()) {
      ...
      case ModelPackage.HUMIDITY_V2_SUB_IDS:
        return createHumidityV2SubIdsFromString(eDataType, initialValue);
      ...
      case ModelPackage.TINKER_BRICKLET_HUMIDITY_V2:
        return createTinkerBrickletHumidityV2FromString(eDataType, initialValue);
      ...
      case ModelPackage.UP_DOWN_VALUE:
        return createUpDownValueFromString(eDataType, initialValue);
      case ModelPackage.INCREASE_DECREASE_VALUE:
        return createIncreaseDecreaseValueFromString(eDataType, initialValue);
   ...
   */
    ...
    switch (eDataType.getClassifierID()) {
      ...
      case ModelPackage.HUMIDITY_V2_SUB_IDS:
        return convertHumidityV2SubIdsToString(eDataType, instanceValue);
      case ModelPackage.MIP_CONNECTION:
      ...
      case ModelPackage.TINKER_BRICKLET_HUMIDITY_V2:
        return convertTinkerBrickletHumidityV2ToString(eDataType, instanceValue);
      case ModelPackage.MTINKER_BRICKLET_DISTANCE_IR:
      ...
      case ModelPackage.UP_DOWN_VALUE:
        return convertUpDownValueToString(eDataType, instanceValue);
      case ModelPackage.INCREASE_DECREASE_VALUE:
        return convertIncreaseDecreaseValueToString(eDataType, instanceValue);
      case ModelPackage.ENUM:
   ...
   * @generated
   */
    public MBrickletHumidityV2 createMBrickletHumidityV2() {
    MBrickletHumidityV2Impl mBrickletHumidityV2 = new MBrickletHumidityV2Impl();
    return mBrickletHumidityV2;
  }
   ...
   * @generated
   */
    public MHumidityV2Temperature createMHumidityV2Temperature() {
    MHumidityV2TemperatureImpl mHumidityV2Temperature = new MHumidityV2TemperatureImpl();
    return mHumidityV2Temperature;
  }
   ...
   * @generated
   */
    public MHumidityV2Humidity createMHumidityV2Humidity() {
    MHumidityV2HumidityImpl mHumidityV2Humidity = new MHumidityV2HumidityImpl();
    return mHumidityV2Humidity;
  }
   ...
   * @generated
   */
    public HumidityV2Configuration createHumidityV2Configuration() {
    HumidityV2ConfigurationImpl humidityV2Configuration = new HumidityV2ConfigurationImpl();
    return humidityV2Configuration;
  }
   ...
   * @generated
   */
    public HumidityV2SubIds createHumidityV2SubIdsFromString(EDataType eDataType, String initialValue) {
    HumidityV2SubIds result = HumidityV2SubIds.get(initialValue);
    if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
    return result;
  }
   ...
   * @generated
   */
    public String convertHumidityV2SubIdsToString(EDataType eDataType, Object instanceValue) {
    return instanceValue == null ? null : instanceValue.toString();
  }
   ...
   * @generated
   */
    public BrickletHumidityV2 createTinkerBrickletHumidityV2FromString(EDataType eDataType, String initialValue) {
    return (BrickletHumidityV2)super.createFromString(eDataType, initialValue);
  }
   ...
   * @generated
   */
    public String convertTinkerBrickletHumidityV2ToString(EDataType eDataType, Object instanceValue) {
    return super.convertToString(eDataType, instanceValue);
  }
   ...
   * @generated
   */
	public UpDownValue createUpDownValueFromString(EDataType eDataType, String initialValue) {
    return (UpDownValue)super.createFromString(eDataType, initialValue);
  }
   ...
   * @generated
   */
	public String convertUpDownValueToString(EDataType eDataType, Object instanceValue) {
    return super.convertToString(eDataType, instanceValue);
  }
   ...
   * @generated
   */
	public IncreaseDecreaseValue createIncreaseDecreaseValueFromString(EDataType eDataType, String initialValue) {
    return (IncreaseDecreaseValue)super.createFromString(eDataType, initialValue);
  }
   ...
   * @generated
   */
	public String convertIncreaseDecreaseValueToString(EDataType eDataType, Object instanceValue) {
    return super.convertToString(eDataType, instanceValue);
  }
