 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#getPin <em>Pin</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#getDefaultState <em>Default State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#isKeepOnReconnect <em>Keep On Reconnect</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDigitalActorIO4()
 * @model
 * @generated
 */
public interface DigitalActorIO4 extends DigitalActor, IO4Device, MTFConfigConsumer<TFIOActorConfiguration> {
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDigitalActorIO4_DeviceType()
   ...
   * @see #setPin(int)
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDigitalActorIO4_Pin()
   * @model unique="false"
   * @generated
   */
	int getPin();
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#getPin <em>Pin</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDigitalActorIO4_DefaultState()
   * @model unique="false"
   * @generated
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#getDefaultState <em>Default State</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getDigitalActorIO4_KeepOnReconnect()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.m1theo.tinkerforge.emf.internal.model.DigitalActorIO4#isKeepOnReconnect <em>Keep On Reconnect</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
