...
import org.m1theo.tinkerforge.emf.internal.model.MBrickletRotaryEncoder;
...
import org.m1theo.tinkerforge.emf.internal.model.RotaryEncoder;
import org.m1theo.tinkerforge.emf.internal.model.RotaryEncoderButton;
import org.m1theo.tinkerforge.emf.internal.model.RotaryEncoderDevice;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getMsubdevices <em>Msubdevices</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletRotaryEncoderImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBrickletRotaryEncoderImpl extends MinimalEObjectImpl.Container implements MBrickletRotaryEncoder {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getMBrickletRotaryEncoder();
  }
   ...
   */
    ...
    uid = newUid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__UID, oldUid, uid));
  }
   ...
   */
    ...
    poll = newPoll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__POLL, oldPoll, poll));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__TINKERFORGE_DEVICE, oldTinkerforgeDevice, tinkerforgeDevice));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__CONNECTED_UID, oldConnectedUid, connectedUid));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__POSITION, oldPosition, position));
  }
   ...
   */
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__NAME, oldName, name));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.MBRICKLET_ROTARY_ENCODER__BRICKD) return null;
   ...
   */
    ...
    if (newBrickd != eInternalContainer() || (eContainerFeatureID() != ModelPackage.MBRICKLET_ROTARY_ENCODER__BRICKD && newBrickd != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_ROTARY_ENCODER__BRICKD, newBrickd, newBrickd));
  }
   ...
   */
    ...
    if (msubdevices == null) {
      msubdevices = new EObjectContainmentWithInverseEList<RotaryEncoderDevice>(RotaryEncoderDevice.class, this, ModelPackage.MBRICKLET_ROTARY_ENCODER__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK) { private static final long serialVersionUID = 1L; @Override public Class<?> getInverseFeatureClass() { return MSubDevice.class; } };
    }
    return msubdevices;
  }
   ...
   */
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_ROTARY_ENCODER__MSUBDEVICES: return ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (baseFeatureID) {
        case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES: return ModelPackage.MBRICKLET_ROTARY_ENCODER__MSUBDEVICES;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (baseOperationID) {
        case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES: return ModelPackage.MBRICKLET_ROTARY_ENCODER___INIT_SUB_DEVICES;
        default: return -1;
      }
    }
