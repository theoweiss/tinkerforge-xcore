 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.MStepperUnderVoltage#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getMStepperUnderVoltage()
...
public interface MStepperUnderVoltage extends MStepperDevice, MSensor<DecimalValue> {
   ...
   * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getMStepperUnderVoltage_DeviceType()
