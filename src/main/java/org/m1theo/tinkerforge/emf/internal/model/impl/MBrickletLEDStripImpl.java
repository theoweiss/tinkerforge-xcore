...
import org.m1theo.tinkerforge.emf.internal.model.LEDGroup;
import org.m1theo.tinkerforge.emf.internal.model.LEDStripConfiguration;
import org.m1theo.tinkerforge.emf.internal.model.MBaseDevice;
import org.m1theo.tinkerforge.emf.internal.model.MBrickd;
import org.m1theo.tinkerforge.emf.internal.model.MBrickletLEDStrip;
...
import org.m1theo.tinkerforge.internal.tools.LedList;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getMsubdevices <em>Msubdevices</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickletLEDStripImpl#getColorMapping <em>Color Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBrickletLEDStripImpl extends MinimalEObjectImpl.Container implements MBrickletLEDStrip {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getMBrickletLEDStrip();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_LED_STRIP__ENABLED_A, oldEnabledA, enabledA));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_LED_STRIP__POSITION, oldPosition, position));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_LED_STRIP__DEVICE_IDENTIFIER, oldDeviceIdentifier, deviceIdentifier));
  }
   ...
   */
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_LED_STRIP__NAME, oldName, name));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.MBRICKLET_LED_STRIP__BRICKD) return null;
   ...
   */
    ...
    if (msubdevices == null) {
      msubdevices = new EObjectContainmentWithInverseEList<LEDGroup>(LEDGroup.class, this, ModelPackage.MBRICKLET_LED_STRIP__MSUBDEVICES, ModelPackage.MSUB_DEVICE__MBRICK) { private static final long serialVersionUID = 1L; @Override public Class<?> getInverseFeatureClass() { return MSubDevice.class; } };
    }
    return msubdevices;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MBRICKLET_LED_STRIP__COLOR_MAPPING, oldColorMapping, colorMapping));
  }
     ...
     */
    @Override
    public void setSelectedColor(HSBValue color, DeviceOptions opts) {
   ...
   */
    ...
    if (baseClass == MBaseDevice.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_LED_STRIP__LOGGER: return ModelPackage.MBASE_DEVICE__LOGGER;
        case ModelPackage.MBRICKLET_LED_STRIP__UID: return ModelPackage.MBASE_DEVICE__UID;
        case ModelPackage.MBRICKLET_LED_STRIP__POLL: return ModelPackage.MBASE_DEVICE__POLL;
        case ModelPackage.MBRICKLET_LED_STRIP__ENABLED_A: return ModelPackage.MBASE_DEVICE__ENABLED_A;
        default: return -1;
      }
    }
    if (baseClass == MDevice.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_LED_STRIP__TINKERFORGE_DEVICE: return ModelPackage.MDEVICE__TINKERFORGE_DEVICE;
        case ModelPackage.MBRICKLET_LED_STRIP__IP_CONNECTION: return ModelPackage.MDEVICE__IP_CONNECTION;
        case ModelPackage.MBRICKLET_LED_STRIP__CONNECTED_UID: return ModelPackage.MDEVICE__CONNECTED_UID;
        case ModelPackage.MBRICKLET_LED_STRIP__POSITION: return ModelPackage.MDEVICE__POSITION;
        case ModelPackage.MBRICKLET_LED_STRIP__DEVICE_IDENTIFIER: return ModelPackage.MDEVICE__DEVICE_IDENTIFIER;
        case ModelPackage.MBRICKLET_LED_STRIP__NAME: return ModelPackage.MDEVICE__NAME;
        case ModelPackage.MBRICKLET_LED_STRIP__BRICKD: return ModelPackage.MDEVICE__BRICKD;
        default: return -1;
      }
    }
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (derivedFeatureID) {
        case ModelPackage.MBRICKLET_LED_STRIP__MSUBDEVICES: return ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MBaseDevice.class) {
      switch (baseFeatureID) {
        case ModelPackage.MBASE_DEVICE__LOGGER: return ModelPackage.MBRICKLET_LED_STRIP__LOGGER;
        case ModelPackage.MBASE_DEVICE__UID: return ModelPackage.MBRICKLET_LED_STRIP__UID;
        case ModelPackage.MBASE_DEVICE__POLL: return ModelPackage.MBRICKLET_LED_STRIP__POLL;
        case ModelPackage.MBASE_DEVICE__ENABLED_A: return ModelPackage.MBRICKLET_LED_STRIP__ENABLED_A;
        default: return -1;
      }
    }
    if (baseClass == MDevice.class) {
      switch (baseFeatureID) {
        case ModelPackage.MDEVICE__TINKERFORGE_DEVICE: return ModelPackage.MBRICKLET_LED_STRIP__TINKERFORGE_DEVICE;
        case ModelPackage.MDEVICE__IP_CONNECTION: return ModelPackage.MBRICKLET_LED_STRIP__IP_CONNECTION;
        case ModelPackage.MDEVICE__CONNECTED_UID: return ModelPackage.MBRICKLET_LED_STRIP__CONNECTED_UID;
        case ModelPackage.MDEVICE__POSITION: return ModelPackage.MBRICKLET_LED_STRIP__POSITION;
        case ModelPackage.MDEVICE__DEVICE_IDENTIFIER: return ModelPackage.MBRICKLET_LED_STRIP__DEVICE_IDENTIFIER;
        case ModelPackage.MDEVICE__NAME: return ModelPackage.MBRICKLET_LED_STRIP__NAME;
        case ModelPackage.MDEVICE__BRICKD: return ModelPackage.MBRICKLET_LED_STRIP__BRICKD;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (baseFeatureID) {
        case ModelPackage.MSUB_DEVICE_HOLDER__MSUBDEVICES: return ModelPackage.MBRICKLET_LED_STRIP__MSUBDEVICES;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MBaseDevice.class) {
      switch (baseOperationID) {
        case ModelPackage.MBASE_DEVICE___INIT: return ModelPackage.MBRICKLET_LED_STRIP___INIT;
        case ModelPackage.MBASE_DEVICE___ENABLE: return ModelPackage.MBRICKLET_LED_STRIP___ENABLE;
        case ModelPackage.MBASE_DEVICE___DISABLE: return ModelPackage.MBRICKLET_LED_STRIP___DISABLE;
        default: return -1;
      }
    }
    if (baseClass == MDevice.class) {
    ...
    if (baseClass == MSubDeviceHolder.class) {
      switch (baseOperationID) {
        case ModelPackage.MSUB_DEVICE_HOLDER___INIT_SUB_DEVICES: return ModelPackage.MBRICKLET_LED_STRIP___INIT_SUB_DEVICES;
        default: return -1;
      }
    }
   ...
   */
    ...
    switch (operationID) {
      ...
      case ModelPackage.MBRICKLET_LED_STRIP___DISABLE:
        disable();
        return null;
      case ModelPackage.MBRICKLET_LED_STRIP___SET_SELECTED_COLOR__HSBVALUE_DEVICEOPTIONS:
        setSelectedColor((HSBValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
    }
