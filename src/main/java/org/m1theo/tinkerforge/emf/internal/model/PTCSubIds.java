 ...
 * <!-- end-user-doc -->
 * @see org.m1theo.tinkerforge.emf.internal.model.ModelPackage#getPTCSubIds()
 * @model
 * @generated
 */
public enum PTCSubIds implements Enumerator {
   ...
   * @generated
   */
	private static final PTCSubIds[] VALUES_ARRAY =
		new PTCSubIds[] {
      PTC_TEMPERATURE,
      PTC_RESISTANCE,
      PTC_CONNECTED,
   ...
   */
    ...
    switch (value) {
      case PTC_TEMPERATURE_VALUE: return PTC_TEMPERATURE;
    }
    return null;
  }
