...
import org.m1theo.tinkerforge.emf.internal.model.ConfigOptsMove;
import org.m1theo.tinkerforge.emf.internal.model.ConfigOptsSwitchSpeed;
import org.m1theo.tinkerforge.emf.internal.model.DCDriveMode;
...
import org.m1theo.tinkerforge.emf.internal.model.MBrickDC;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getSwitchState <em>Switch State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getTinkerforgeDevice <em>Tinkerforge Device</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getIpConnection <em>Ip Connection</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getConnectedUid <em>Connected Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getDeviceIdentifier <em>Device Identifier</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getBrickd <em>Brickd</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getPercentValue <em>Percent Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getThreshold <em>Threshold</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getMaxVelocity <em>Max Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getMinVelocity <em>Min Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getVelocity <em>Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getTargetvelocity <em>Targetvelocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getCurrentVelocity <em>Current Velocity</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getPwmFrequency <em>Pwm Frequency</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.MBrickDCImpl#getDriveMode <em>Drive Mode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MBrickDCImpl extends MinimalEObjectImpl.Container implements MBrickDC {
   ...
   */
     ...
     */
    @Override
    public void setValue(PercentValue percentValue, DeviceOptions opts) {
        ...
        Short newVelocity = abs.divide(new BigDecimal(100)).multiply(percentValue.getValue()).subtract(min.abs())
                .shortValue();
    ...
    public void moveon(DeviceOptions opts) {
        if (direction != null && direction != DirectionValue.UNDEF) {
            UpDownValue directiontmp = this.direction == DirectionValue.LEFT ? UpDownValue.UP : UpDownValue.DOWN;
     ...
     */
    @Override
    public void move(UpDownValue direction, DeviceOptions opts) {
        if (opts == null) {
            logger.error("Brick DC options are missing");
            return;
        }
        ...
        if (direction.equals(UpDownValue.DOWN)) {
        ...
        } else if (direction.equals(UpDownValue.UP)) {
   ...
   */
    ...
    if (baseClass == MoveActor.class) {
      switch (baseOperationID) {
        case ModelPackage.MOVE_ACTOR___MOVE__UPDOWNVALUE_DEVICEOPTIONS: return ModelPackage.MBRICK_DC___MOVE__UPDOWNVALUE_DEVICEOPTIONS;
    ...
    if (baseClass == DimmableActor.class) {
      switch (baseOperationID) {
        case ModelPackage.DIMMABLE_ACTOR___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS: return ModelPackage.MBRICK_DC___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
    if (baseClass == PercentTypeActor.class) {
      switch (baseOperationID) {
        case ModelPackage.PERCENT_TYPE_ACTOR___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS: return ModelPackage.MBRICK_DC___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
    if (baseClass == SetPointActor.class) {
   ...
   */
    ...
    switch (operationID) {
      ...
      case ModelPackage.MBRICK_DC___SET_VALUE__BIGDECIMAL_DEVICEOPTIONS:
        ...
        return null;
      case ModelPackage.MBRICK_DC___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS:
        setValue((PercentValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
      case ModelPackage.MBRICK_DC___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS:
        dimm((IncreaseDecreaseValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
      case ModelPackage.MBRICK_DC___MOVE__UPDOWNVALUE_DEVICEOPTIONS:
        move((UpDownValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
