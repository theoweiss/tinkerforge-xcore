...
import org.m1theo.tinkerforge.emf.internal.model.MBrickletRemoteSwitch;
import org.m1theo.tinkerforge.emf.internal.model.MInSwitchActor;
...
import org.m1theo.tinkerforge.emf.internal.model.RemoteSwitch;
import org.m1theo.tinkerforge.emf.internal.model.RemoteSwitchB;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getSwitchState <em>Switch State</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getPercentValue <em>Percent Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getDeviceType <em>Device Type</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getRepeats <em>Repeats</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.RemoteSwitchBImpl#getAbsDimmValue <em>Abs Dimm Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RemoteSwitchBImpl extends MinimalEObjectImpl.Container implements RemoteSwitchB {
  ...
  public void setPercentValue(PercentValue newPercentValue) {
    ...
    public void setValue(PercentValue newValue, DeviceOptions opts) {
        ...
        short value = getMaxValue().multiply(newValue.getValue())
   ...
   */
    ...
    if (baseClass == DimmableActor.class) {
      switch (baseOperationID) {
        case ModelPackage.DIMMABLE_ACTOR___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS: return ModelPackage.REMOTE_SWITCH_B___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
    if (baseClass == PercentTypeActor.class) {
      switch (baseOperationID) {
        case ModelPackage.PERCENT_TYPE_ACTOR___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS: return ModelPackage.REMOTE_SWITCH_B___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS;
        default: return -1;
      }
    }
   ...
   */
    ...
    switch (operationID) {
      case ModelPackage.REMOTE_SWITCH_B___SET_VALUE__PERCENTVALUE_DEVICEOPTIONS:
        setValue((PercentValue)arguments.get(0), (DeviceOptions)arguments.get(1));
        return null;
      case ModelPackage.REMOTE_SWITCH_B___DIMM__INCREASEDECREASEVALUE_DEVICEOPTIONS:
