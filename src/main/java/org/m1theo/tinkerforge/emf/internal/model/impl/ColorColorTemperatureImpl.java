...
import org.m1theo.tinkerforge.emf.internal.model.ColorColorTemperature;
import org.m1theo.tinkerforge.emf.internal.model.MBrickletColor;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getLogger <em>Logger</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#isPoll <em>Poll</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getEnabledA <em>Enabled A</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getSubId <em>Sub Id</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getMbrick <em>Mbrick</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getSensorValue <em>Sensor Value</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getTfConfig <em>Tf Config</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getCallbackPeriod <em>Callback Period</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.ColorColorTemperatureImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColorColorTemperatureImpl extends MinimalEObjectImpl.Container implements ColorColorTemperature {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getColorColorTemperature();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__LOGGER, oldLogger, logger));
  }
   ...
   */
    ...
    uid = newUid;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__UID, oldUid, uid));
  }
   ...
   */
    ...
    poll = newPoll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__POLL, oldPoll, poll));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__ENABLED_A, oldEnabledA, enabledA));
  }
   ...
   */
    ...
    subId = newSubId;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__SUB_ID, oldSubId, subId));
  }
   ...
   */
    ...
    if (eContainerFeatureID() != ModelPackage.COLOR_COLOR_TEMPERATURE__MBRICK) return null;
   ...
   */
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG, oldTfConfig, newTfConfig);
   ...
   */
    ...
    if (newTfConfig != tfConfig) {
      NotificationChain msgs = null;
      if (tfConfig != null)
        msgs = ((InternalEObject)tfConfig).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG, null, msgs);
      if (newTfConfig != null)
        msgs = ((InternalEObject)newTfConfig).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG, null, msgs);
      msgs = basicSetTfConfig(newTfConfig, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG, newTfConfig, newTfConfig));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COLOR_COLOR_TEMPERATURE__CALLBACK_PERIOD, oldCallbackPeriod, callbackPeriod));
  }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (derivedFeatureID) {
        case ModelPackage.COLOR_COLOR_TEMPERATURE__SENSOR_VALUE: return ModelPackage.MSENSOR__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (derivedFeatureID) {
        case ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG: return ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
      switch (derivedFeatureID) {
        case ModelPackage.COLOR_COLOR_TEMPERATURE__CALLBACK_PERIOD: return ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseFeatureID) {
        case ModelPackage.MSENSOR__SENSOR_VALUE: return ModelPackage.COLOR_COLOR_TEMPERATURE__SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
      switch (baseFeatureID) {
        case ModelPackage.MTF_CONFIG_CONSUMER__TF_CONFIG: return ModelPackage.COLOR_COLOR_TEMPERATURE__TF_CONFIG;
        default: return -1;
      }
    }
    if (baseClass == CallbackListener.class) {
      switch (baseFeatureID) {
        case ModelPackage.CALLBACK_LISTENER__CALLBACK_PERIOD: return ModelPackage.COLOR_COLOR_TEMPERATURE__CALLBACK_PERIOD;
        default: return -1;
      }
    }
   ...
   */
    ...
    if (baseClass == MSensor.class) {
      switch (baseOperationID) {
        case ModelPackage.MSENSOR___FETCH_SENSOR_VALUE: return ModelPackage.COLOR_COLOR_TEMPERATURE___FETCH_SENSOR_VALUE;
        default: return -1;
      }
    }
    if (baseClass == MTFConfigConsumer.class) {
