 ...
 * </p>
 * <ul>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.BrickletOLEDConfigurationImpl#getContrast <em>Contrast</em>}</li>
 *   <li>{@link org.m1theo.tinkerforge.emf.internal.model.impl.BrickletOLEDConfigurationImpl#isInvert <em>Invert</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BrickletOLEDConfigurationImpl extends MinimalEObjectImpl.Container implements BrickletOLEDConfiguration {
   ...
   */
    ...
    return ModelPackage.eINSTANCE.getBrickletOLEDConfiguration();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BRICKLET_OLED_CONFIGURATION__CONTRAST, oldContrast, contrast));
  }
   ...
   */
    ...
    invert = newInvert;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.BRICKLET_OLED_CONFIGURATION__INVERT, oldInvert, invert));
  }
